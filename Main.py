...
def main():
    ...
    i = 0
    ty = 0
    file_name1 = "picsrc/industry_same/"
    file_name2 = "picsrc/self_history/"
    file_name3 = "picsrc/self_future/"
    try:
    ...
    for i in range(10):
        ...
        close2.clear()
        plt.savefig('picsrc/industry_same/'+str(i + 1)+'.png', dpi=100)
        plt.close()
    ...
    for i in range(9):
        ...
        delta2 = datetime.timedelta(days=begindate[i]+days+5)
        ...
        plt.savefig('picsrc/self_history/' + str(i + 1) + '.png', dpi=100)
        plt.close()
    print('Analysis done!')
    database.close()
from tkinter import *
...
def industry_same_picshow():
    rt = Tk()
    rt.title('9支同行业最相近的股票')
    rt.geometry('1500x1300')
    canvas = Canvas(rt, bg='white', height=1500, width=1300)
    Label(canvas, text='9支同行业最相近的股票', font=('楷体', 30)).place(relx=0.3, rely=0)
    image_file1 = PhotoImage(file='picsrc/industry_same/1.png')
    canvas.create_image(0, 50, anchor='nw', image=image_file1)
    canvas.pack()
    image_file2 = PhotoImage(file='picsrc/industry_same/2.png')
    canvas.create_image(400, 50, anchor='nw', image=image_file2)
    canvas.pack()
    image_file3 = PhotoImage(file='picsrc/industry_same/3.png')
    canvas.create_image(800, 50, anchor='nw', image=image_file3)
    canvas.pack()
    image_file4 = PhotoImage(file='picsrc/industry_same/4.png')
    canvas.create_image(0, 250, anchor='nw', image=image_file4)
    canvas.pack()
    image_file5 = PhotoImage(file='picsrc/industry_same/5.png')
    canvas.create_image(400, 250, anchor='nw', image=image_file5)
    canvas.pack()
    image_file6 = PhotoImage(file='picsrc/industry_same/6.png')
    canvas.create_image(800, 250, anchor='nw', image=image_file6)
    canvas.pack()
    image_file7 = PhotoImage(file='picsrc/industry_same/7.png')
    canvas.create_image(0, 450, anchor='nw', image=image_file7)
    canvas.pack()
    image_file8 = PhotoImage(file='picsrc/industry_same/8.png')
    canvas.create_image(400, 450, anchor='nw', image=image_file8)
    canvas.pack()
    image_file9 = PhotoImage(file='picsrc/industry_same/9.png')
...
def his_picshow():
    ...
    Label(canvas, text='自身涨跌幅的预测', font=('楷体', 30)).place(relx=0.4, rely=0)
    image_file1 = PhotoImage(file='picsrc/self_history/1.png')
    canvas.create_image(0, 50, anchor='nw', image=image_file1)
    canvas.pack()
    image_file2 = PhotoImage(file='picsrc/self_history/2.png')
    canvas.create_image(400, 50, anchor='nw', image=image_file2)
    canvas.pack()
    image_file3 = PhotoImage(file='picsrc/self_history/3.png')
    canvas.create_image(800, 50, anchor='nw', image=image_file3)
    canvas.pack()
    image_file4 = PhotoImage(file='picsrc/self_history/4.png')
    canvas.create_image(0, 250, anchor='nw', image=image_file4)
    canvas.pack()
    image_file5 = PhotoImage(file='picsrc/self_history/5.png')
    canvas.create_image(400, 250, anchor='nw', image=image_file5)
    canvas.pack()
    image_file6 = PhotoImage(file='picsrc/self_history/6.png')
    canvas.create_image(800, 250, anchor='nw', image=image_file6)
    canvas.pack()
    image_file7 = PhotoImage(file='picsrc/self_history/7.png')
    canvas.create_image(0, 450, anchor='nw', image=image_file7)
    canvas.pack()
    image_file8 = PhotoImage(file='picsrc/self_history/9.png')
    canvas.create_image(400, 450, anchor='nw', image=image_file8)
    canvas.pack()
    image_file9 = PhotoImage(file='picsrc/self_history/8.png')
    canvas.create_image(800, 450, anchor='nw', image=image_file9)
    canvas.pack()
    rh.mainloop()
def Show():
